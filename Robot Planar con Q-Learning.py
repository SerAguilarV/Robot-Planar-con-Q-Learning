...
def get_trayectoria():
    ...
    if tipoDeTrayectoria == 1:
        ...
        Robot_Planar = Robot(L1 = 4, L2 = 3, L3 = 3, numeroPuntos = len(Puntos), Add = 2 )
        Ai,Bi,Ci = [40,50,20]
    else:
    ...
    return Puntos, Robot_Planar, [Ai,Bi,Ci]

def get_obstaculos(Puntos):
    ...
    return crearObst, VXF, VYF, limites   
...
if __name__ == '__main__':
    Puntos, Robot_Planar, Ang_Iniciales = get_trayectoria()
    Ai,Bi,Ci = Ang_Iniciales
    
    crearObst, VXF, VYF, limites = get_obstaculos(Puntos)
